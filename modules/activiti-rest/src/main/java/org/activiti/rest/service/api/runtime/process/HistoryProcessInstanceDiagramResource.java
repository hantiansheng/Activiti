...
public class HistoryProcessInstanceDiagramResource extends BaseProcessInstanceResource {
  ...
  @RequestMapping(value = "/history/process-instances/{processInstanceId}/diagram", method = RequestMethod.GET)
